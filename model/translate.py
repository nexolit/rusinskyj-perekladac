...
# BPE Model
bpe_model = youtokentome.BPE(model="corpus/bpe.model")
...
if __name__ == '__main__':
    #print(translate("Я Русын быв.")[0])
    RUSYN_SLOVAK_MODEL = "rusyn-slovak.tar"
    print(translate("Я Русин быв, єсм и буду,", RUSYN_SLOVAK_MODEL)[0])
    print(translate("Я родився Русином,", RUSYN_SLOVAK_MODEL)[0])
    print(translate("Честный мой род не забуду,", RUSYN_SLOVAK_MODEL)[0])
    print(translate("Останусь єго сыном.", RUSYN_SLOVAK_MODEL)[0])
